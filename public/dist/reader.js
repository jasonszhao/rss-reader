(function (global, factory) {
  ...
  */
  ...
  function isNullOrUndef$1(o) {
      return isUndefined$2(o) || isNull$1(o);
  }
  function isInvalid$1(o) {
      return isNull$1(o) || o === false || isTrue$1(o) || isUndefined$2(o);
  }
  ...
  function isSameLinkEvent(lastValue, nextValue) {
      return lastValue && nextValue && isObject$2(lastValue) && isObject$2(nextValue) && lastValue.event === nextValue.event && lastValue.data === nextValue.data;
  }
  ...
  function createTextVNode$1(text, key) {
      return new V(1 /* HasInvalidChildren */, isNullOrUndef$1(text) ? '' : text, null, 16 /* Text */, key, null, null, null);
  }
  ...
  var attachedEventCounts$1 = getDelegatedEventObject(0);
  var attachedEvents$1 = getDelegatedEventObject(null);
  var delegatedEvents = getDelegatedEventObject(true);
  function handleEvent$1(name, nextEvent, dom) {
      var eventsObject = dom.$EV;
      if (nextEvent) {
  ...
  function dispatchEvents$1(event, target, isClick, name, eventData) {
      var dom = target;
      while (!isNull$1(dom)) {
          // Html Nodes can be nested fe: span inside button in that scenario browser does not handle disabled attribute on parent,
          // because the event listener is on document.body
  ...
  function attachEventToDocument$1(name) {
      var docEvent = function (event) {
          ...
          dispatchEvents$1(event, event.target, isClick, name, eventData);
      };
      document.addEventListener(normalizeEventName$1(name), docEvent);
      return docEvent;
  }
  ...
  var onTextInputChange$1 = createWrappedFunction$1('onInput', applyValueInput$1);
  var wrappedOnChange$2 = createWrappedFunction$1(['onClick', 'onChange'], applyValueInput$1);
  /* tslint:disable-next-line:no-empty */
  ...
  function inputEvents$1(dom, nextPropsOrEmpty) {
      if (isCheckedType$1(nextPropsOrEmpty.type)) {
          attachEvent(dom, 'change', wrappedOnChange$2);
          attachEvent(dom, 'click', emptywrapper$1);
      } else {
          attachEvent(dom, 'input', onTextInputChange$1);
      }
  }
  function applyValueInput$1(nextPropsOrEmpty, dom) {
      ...
      var multiple = nextPropsOrEmpty.multiple;
      var defaultValue = nextPropsOrEmpty.defaultValue;
      var hasValue = !isNullOrUndef$1(value);
      if (type && type !== dom.type) {
          dom.setAttribute('type', type);
      }
  ...
  var onSelectChange$1 = createWrappedFunction$1('onChange', applyValueSelect$1);
  function selectEvents$1(dom) {
      attachEvent(dom, 'change', onSelectChange$1);
  }
  ...
  var onTextareaInputChange$1 = createWrappedFunction$1('onInput', applyValueTextArea$1);
  var wrappedOnChange$1$1 = createWrappedFunction$1('onChange');
  function textAreaEvents$1(dom, nextPropsOrEmpty) {
      attachEvent(dom, 'input', onTextareaInputChange$1);
      if (nextPropsOrEmpty.onChange) {
          attachEvent(dom, 'change', wrappedOnChange$1$1);
      }
  }
  ...
  function processElement$1(flags, vNode, dom, nextPropsOrEmpty, mounting, isControlled) {
      if (flags & 64 /* InputElement */) {
              applyValueInput$1(nextPropsOrEmpty, dom);
          } else if (flags & 256 /* SelectElement */) {
              applyValueSelect$1(nextPropsOrEmpty, dom, mounting, vNode);
          } else if (flags & 128 /* TextareaElement */) {
              applyValueTextArea$1(nextPropsOrEmpty, dom, mounting);
          }
      if (isControlled) {
          dom.$V = vNode;
      }
  ...
  function isControlledFormElement$1(nextPropsOrEmpty) {
      return nextPropsOrEmpty.type && isCheckedType$1(nextPropsOrEmpty.type) ? !isNullOrUndef$1(nextPropsOrEmpty.checked) : !isNullOrUndef$1(nextPropsOrEmpty.value);
  }
  ...
  function remove$2(vNode, parentDOM) {
      unmount$1(vNode);
      if (parentDOM) {
  ...
  function unmount$1(vNode) {
      ...
      if (flags & 481 /* Element */) {
              ...
              if (!isNull$1(props)) {
                  ...
                  for (var i = 0, len = keys.length; i < len; i++) {
                      ...
                      if (delegatedEvents[key]) {
                          handleEvent$1(key, null, vNode.dom);
                      }
                  }
              }
              if (childFlags & 12 /* MultipleChildren */) {
          ...
          if (flags & 4 /* ComponentClass */) {
                  ...
                  ref = vNode.ref;
                  if (!isNullOrUndef$1(ref) && isFunction$3(ref.onComponentWillUnmount)) {
                      ref.onComponentWillUnmount(findDOMfromVNode(vNode, true), vNode.props || EMPTY_OBJ$1);
                  }
                  unmount$1(children);
              } else if (flags & 1024 /* Portal */) {
                  remove$2(children, vNode.ref);
              } else if (flags & 8192 /* Fragment */) {
  ...
  function createLinkEvent$1(linkEvent, nextValue) {
      return function (e) {
          linkEvent(nextValue.data, e);
      };
  }
  function patchEvent$1(name, lastValue, nextValue, dom) {
      var event = normalizeEventName$1(name);
      if (isObject$2(nextValue) && !isNull$1(nextValue)) {
          var linkEvent = nextValue.event;
          if (!isSameLinkEvent(lastValue, nextValue)) {
              attachEvent(dom, event, createLinkEvent$1(linkEvent, nextValue));
          }
      } else {
  ...
  function patchStyle$1(lastAttrValue, nextAttrValue, dom) {
      ...
      if (!isNullOrUndef$1(lastAttrValue) && !isString$2(lastAttrValue)) {
          for (style in nextAttrValue) {
              // do not add a hasOwnProperty check here, it affects performance
              value = nextAttrValue[style];
              if (value !== lastAttrValue[style]) {
  ...
  function patchProp$1(prop, lastValue, nextValue, dom, isSVG, hasControlledValue, lastVNode) {
      switch (prop) {
          ...
          case 'dangerouslySetInnerHTML':
              ...
              var nextHtml = nextValue && nextValue.__html || '';
              if (lastHtml !== nextHtml) {
                  if (!isNullOrUndef$1(nextHtml) && !isSameInnerHTML$1(dom, nextHtml)) {
          ...
          default:
              if (delegatedEvents[prop]) {
                  if (!isSameLinkEvent(lastValue, nextValue)) {
                      handleEvent$1(prop, nextValue, dom);
                  }
  ...
  function renderNewInput(instance, props, context) {
      var nextInput = handleComponentInput$1(instance.render(props, instance.state, context));
  ...
  function mountPortal(vNode, context, parentDOM, nextNode, lifecycle) {
      ...
      var placeHolderVNode = createVoidVNode$1();
  ...
  function mountFragment(vNode, parentDOM, context, isSVG, nextNode, lifecycle) {
      ...
      if (childFlags & 12 /* MultipleChildren */ && children.length === 0) {
          ...
          children = vNode.children = createVoidVNode$1();
      }
      if (childFlags === 2 /* HasVNodeChildren */) {
  ...
  function mountElement$1(vNode, parentDOM, context, isSVG, nextNode, lifecycle) {
      ...
      var childFlags = vNode.childFlags;
      isSVG = isSVG || (flags & 32 /* SvgElement */) > 0;
      var dom = documentCreateElement$1(vNode.type, isSVG);
      vNode.dom = dom;
      ...
      if (childFlags === 16 /* HasTextChildren */) {
              ...
              if (childFlags === 2 /* HasVNodeChildren */) {
                      if (children.flags & 16384 /* InUse */) {
                              vNode.children = children = directClone$1(children);
                          }
      ...
      mountRef$1(ref, dom, lifecycle);
  }
  function mountArrayChildren$1(children, dom, context, isSVG, nextNode, lifecycle) {
      for (var i = 0, len = children.length; i < len; ++i) {
          var child = children[i];
          if (child.flags & 16384 /* InUse */) {
                  children[i] = child = directClone$1(child);
              }
          mount$1(child, dom, context, isSVG, nextNode, lifecycle);
      }
  }
  function mountClassComponent(vNode, parentDOM, context, isSVG, nextNode, lifecycle) {
      var instance = createClassComponentInstance$1(vNode, vNode.type, vNode.props || EMPTY_OBJ$1, context, isSVG, lifecycle);
  ...
  function mountFunctionalComponent(vNode, parentDOM, context, isSVG, nextNode, lifecycle) {
      ...
      var props = vNode.props || EMPTY_OBJ$1;
      var ref = vNode.ref;
      var input = handleComponentInput$1(vNode.flags & 32768 /* ForwardRef */ ? type(props, ref, context) : type(props, context));
      vNode.children = input;
      mount$1(input, parentDOM, context, isSVG, nextNode, lifecycle);
      mountFunctionalComponentCallbacks$1(props, ref, vNode, lifecycle);
  }
  ...
  function createOnMountCallback$1(ref, vNode, props) {
      return function () {
          ref.onComponentDidMount(findDOMfromVNode(vNode, true), props);
      };
  }
  function mountFunctionalComponentCallbacks$1(props, ref, vNode, lifecycle) {
      if (!isNullOrUndef$1(ref)) {
          if (isFunction$3(ref.onComponentWillMount)) {
              ref.onComponentWillMount(props);
          }
          if (isFunction$3(ref.onComponentDidMount)) {
              lifecycle.push(createOnMountCallback$1(ref, vNode, props));
          }
      }
  }
  ...
  function patchFragment(lastVNode, nextVNode, parentDOM, context, isSVG, lifecycle) {
      ...
      if (nextChildFlags & 12 /* MultipleChildren */ && nextChildren.length === 0) {
          ...
          nextChildren = nextVNode.children = createVoidVNode$1();
      }
  ...
  function patchPortal$1(lastVNode, nextVNode, context, lifecycle) {
      ...
      nextVNode.dom = lastVNode.dom;
      if (lastContainer !== nextContainer && !isInvalid$1(nextChildren)) {
          var node = nextChildren.dom;
  ...
  function patchElement$1(lastVNode, nextVNode, context, isSVG, nextFlags, lifecycle) {
      ...
      if (lastProps !== nextProps) {
          ...
          nextPropsOrEmpty = nextProps || EMPTY_OBJ$1;
          ...
          if (lastPropsOrEmpty !== EMPTY_OBJ$1) {
              for (var prop$1 in lastPropsOrEmpty) {
                  if (isNullOrUndef$1(nextPropsOrEmpty[prop$1]) && !isNullOrUndef$1(lastPropsOrEmpty[prop$1])) {
  ...
  function replaceOneVNodeWithMultipleVNodes(lastChildren, nextChildren, parentDOM, context, isSVG, lifecycle) {
      ...
      mountArrayChildren$1(nextChildren, parentDOM, context, isSVG, findDOMfromVNode(lastChildren, true), lifecycle);
          ...
          case 2 /* HasVNodeChildren */:
              switch (nextChildFlags) {
                  case 2 /* HasVNodeChildren */:
                      ...
                      break;
                  case 1 /* HasInvalidChildren */:
                      remove$2(lastChildren, parentDOM);
                      break;
                  case 16 /* HasTextChildren */:
                      unmount$1(lastChildren);
                      setTextContent(parentDOM, nextChildren);
  ...
  function patchFunctionalComponent(lastVNode, nextVNode, parentDOM, context, isSVG, nextNode, lifecycle) {
      ...
      var nextRef = nextVNode.ref;
      var lastProps = lastVNode.props;
      var nextHooksDefined = !isNullOrUndef$1(nextRef);
      var lastInput = lastVNode.children;
      ...
      if (shouldUpdate !== false) {
          ...
          var nextInput = handleComponentInput$1(nextVNode.flags & 32768 /* ForwardRef */ ? type(nextProps, nextRef, context) : type(nextProps, context));
  ...
  function patchNonKeyedChildren$1(lastChildren, nextChildren, dom, context, isSVG, lastChildrenLength, nextChildrenLength, nextNode, lifecycle) {
      ...
      for (; i < commonLength; ++i) {
          ...
          if (nextChild.flags & 16384 /* InUse */) {
                  nextChild = nextChildren[i] = directClone$1(nextChild);
              }
  ...
  function patchKeyedChildren$1(a, b, dom, context, isSVG, aLength, bLength, outerEdge, parentVNode, lifecycle) {
      ...
      outer: {
          ...
          while (aNode.key === bNode.key) {
              if (bNode.flags & 16384 /* InUse */) {
                      b[bEnd] = bNode = directClone$1(bNode);
                  }
              patch$1(aNode, bNode, dom, context, isSVG, outerEdge, lifecycle);
              a[aEnd] = bNode;
              aEnd--;
          ...
          if (canRemoveWholeContent) {
              ...
              for (i = bLeft - 1; i >= 0; i--) {
                  if (sources[i] === 0) {
                      ...
                      bNode = b[pos];
                      if (bNode.flags & 16384 /* InUse */) {
                              b[pos] = bNode = directClone$1(bNode);
                          }
                      nextPos = pos + 1;
  ...
  var documentBody$1 = null;
  if (hasDocumentAvailable) {
      documentBody$1 = document.body;
      /*
  ...
  var QUEUE = [];
  var nextTick$1 = typeof Promise !== 'undefined' ? Promise.resolve().then.bind(Promise.resolve()) : setTimeout.bind(window);
  ...
  function rerender() {
      ...
      while (component = QUEUE.pop()) {
          var queue = component.$QU;
          applyState$1(component, false, queue ? callSetStateCallbacks.bind(null, component) : null);
      }
  }
  function applyState$1(component, force, callback) {
      ...
      if (force || !component.$BR) {
          ...
          var lifecycle = [];
          renderCheck.v = true;
          updateClassComponent$1(component, combineFrom$1(component.state, pendingState), component.props, findDOMfromVNode(component.$LI, true).parentNode, component.context, component.$SVG, force, null, lifecycle);
          if (lifecycle.length > 0) {
              callAll$1(lifecycle);
          }
          renderCheck.v = false;
  ...
  var clamp$1 = function clamp(n, lowerBound, upperBound) {
  ...
  var createMemoryHistory = function createMemoryHistory() {
    ...
    var push = function push(path, state) {
      browser(!((typeof path === 'undefined' ? 'undefined' : _typeof$3(path)) === 'object' && path.state !== undefined && state !== undefined), 'You should avoid providing a 2nd state argument to push when the 1st ' + 'argument is a location-like object that already has state; it is ignored');
    ...
    var replace = function replace(path, state) {
      browser(!((typeof path === 'undefined' ? 'undefined' : _typeof$3(path)) === 'object' && path.state !== undefined && state !== undefined), 'You should avoid providing a 2nd state argument to replace when the 1st ' + 'argument is a location-like object that already has state; it is ignored');
  ...
  function isInvalid$2(o) {
      return isNull$2(o) || o === false || isTrue$2(o) || isUndefined$3(o);
  }
  function isNull$2(o) {
      return o === null;
  }
  ...
  var Router = /*@__PURE__*/function (Component) {
      ...
      Router.prototype.getChildContext = function getChildContext() {
          var childContext = combineFrom$2(this.context.router, null);
  ...
  function objectWithoutProperties(obj, exclude) {
      var target = {};for (var k in obj) if (Object.prototype.hasOwnProperty.call(obj, k) && exclude.indexOf(k) === -1) target[k] = obj[k];return target;
  }
  ...
  var StaticRouter = /*@__PURE__*/function (Component) {
      function StaticRouter() {
          ...
          this.createHref = function (path) {
              return addLeadingSlash$1(this$1.props.basename + createURL(path));
          };
      ...
      StaticRouter.prototype.render = function render(ref) {
          ...
          return createComponentVNode$1(4 /* ComponentClass */, Router, combineFrom$2(props, {
              history: {
                  action: 'POP',
  ...
  function addBasename(basename, location) {
      ...
      return combineFrom$2(location, { pathname: addLeadingSlash$1(basename) + location.pathname });
  }
  function stripBasename$1(basename, location) {
      ...
      return combineFrom$2(location, { pathname: location.pathname.substr(base.length) });
  }
  ...
  function staticHandler(methodName) {
      return function () {
          invariant$1(false, 'You cannot %s with <StaticRouter>', methodName);
      };
  }
  ...
  var BrowserRouter = /*@__PURE__*/function (Component) {
      ...
      BrowserRouter.prototype.render = function render() {
          return createComponentVNode$1(4 /* ComponentClass */, Router, {
  ...
  var Route = /*@__PURE__*/function (Component) {
      ...
      Route.prototype.render = function render() {
          ...
          if (component) {
              return match ? createComponentVNode$1(2 /* ComponentUnknown */, component, props) : null;
          }
          if (render) {
  ...
  var Switch = /*@__PURE__*/function (Component) {
      ...
      Switch.prototype.render = function render() {
          ...
          if (match) {
              return createComponentVNode$1(_child.flags, _child.type, combineFrom$2(_child.props, { location: location, computedMatch: match }));
          }
          return null;
      };
  ...
  var Prompt = /*@__PURE__*/function (Component) {
      ...
      Prompt.prototype.componentWillMount = function componentWillMount() {
          invariant$1(this.context.router, 'You should not use <Prompt> outside a <Router>');
          if (this.props.when) {
  ...
  var Redirect = /*@__PURE__*/function (Component) {
      ...
      Redirect.prototype.componentWillMount = function componentWillMount() {
          invariant$1(this.context.router, 'You should not use <Redirect> outside a <Router>');
          if (this.isStatic()) {
              this.perform();
          }
      };
  ...
  var filter$2 = lib.curryN(2, function (fn, s) {
  ...
  var ViewEdit = function ViewEdit(_ref) {
      var model = _ref.model;
      return createVNode$2(1, 'main', null, model.source_categories.map(function (cat) {
          return createVNode$2(1, 'article', null, [createVNode$2(1, 'h2', null, cat.name, 0), model.sources.filter(function (s) {
              return s.category_id === cat.id;
          }).map(function (s) {
              return createVNode$2(1, 'p', null, s.url, 0);
          })], 0);
      }), 0);
  };
      ...
      case UPDATE_FEED_SOURCE:
        return _extends$4({}, model, {
          sources: model.sources.map(function (source) {
            return source.id === action.source_id ? _extends$4({}, source, {
  ...
  var createVNode$3 = createVNode,
      createComponentVNode$2 = createComponentVNode,
      createTextVNode$2 = createTextVNode;
  var ViewArticle = function ViewArticle(model, source, article) {
    ...
    return createVNode$3(1, 'article', null, [createVNode$3(1, 'h1', null, strip_html(article.title), 0), createVNode$3(1, 'div', null, [strip_html(source.meta.title), createTextVNode$2(" "), createTextVNode$2(' ('), createVNode$3(1, 'a', null, new URI(link).hostname(), 0, {
      'href': link
    }), createTextVNode$2(')'), createTextVNode$2(" "), createTextVNode$2(' '), date], 0), createVNode$3(1, 'div', null, createTextVNode$2('Summary'), 2), createVNode$3(1, 'div', 'summary', null, 1, {
      'dangerouslySetInnerHTML': { __html: purify.sanitize(article.summary) }
    })], 4, null, article.id);
  };

  var ViewMain = function ViewMain(_ref) {
    var model = _ref.model;
    return createVNode$3(1, 'main', null, [pipe(chain$1(function (source) {
    ...
    }), map$1(prop("view")))(Object.values(model.cached_sources)), createVNode$3(1, 'p', 'footer', createTextVNode$2('That\'s it for now. Take a deep breath and enjoy some fresh air outside.'), 2)], 0);
  };

  function render$2(model) {
    render(createComponentVNode$2(2, BrowserRouter, {
      children: createComponentVNode$2(2, Switch, {
        children: [createComponentVNode$2(2, Route, {
          'exact': true,
          'path': '/',
          'render': function render$$1() {
            return createComponentVNode$2(2, ViewMain, {
              'model': model
            });
          }
        }), createComponentVNode$2(2, Route, {
          'path': '/edit/feeds',
          'render': function render$$1() {
            return createComponentVNode$2(2, ViewEdit, {
              'model': model
            });
          }
        })]
  ...
  model.map(curryN$1(2, log)('rendering with model: ')).map(function (model) {
    return window.requestAnimationFrame(curryN$1(2, render$2)(model));
  });
  ...
  var incomingExternalActions$ = forwardTo(actions, function (action) {
    return log('incomingExternalActions$: ', _extends$4({}, action, { replicate: false }));
  });

  var outgoingExternalActions$ = filter$2(prop('replicate'), actions);
  ...
  var reader = { init: init$1, initial_actions: initial_actions, model: model, update: update$1, render: render$2, reorder_feed_source: reorder_feed_source };
